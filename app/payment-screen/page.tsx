  ...
  return (
    <main className="min-h-screen bg-[#FAF6F2] px-6 py-8">
      ...
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold text-[#4A2E1D]">Complete Your Payment</h1>
      </div>
      ...
      <div className="max-w-md mx-auto">
        ...
        <Card className="border-[#ECE5DF] rounded-2xl shadow-sm mb-6">
          <CardContent className="p-6">
            <h2 className="text-lg font-semibold text-[#4A2E1D] mb-4">Mole Scan Service</h2>

            <p className="text-[#4A2E1D]/80 mb-6">£99 per mole scan includes a review by a UK GP.</p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[#4A2E1D]">Expert assessment by UK GP</p>
                </div>
              </div>
            ...
            <div className="flex justify-between items-center">
              <p className="text-[#4A2E1D]">Total</p>
              <p className="font-bold text-[#4A2E1D] text-xl">£99</p>
            </div>
          </CardContent>
        </Card>
        ...
        >
          {isProcessing ? "Processing..." : "Continue to Upload"}
        </Button>
