...
export default function CompleteScanPaymentScreen() {
  ...
  return (
    <main className="min-h-screen bg-[#FAF6F2] px-6 py-8">
      ...
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold text-[#4A2E1D]">Complete Your Scan</h1>
      </div>
      ...
      <div className="max-w-md mx-auto">
        ...
        <Card className="border-[#ECE5DF] rounded-2xl shadow-sm mb-6">
          <CardContent className="p-6">
            <h2 className="text-lg font-semibold text-[#4A2E1D] mb-4">Mole Check Service</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[#4A2E1D]">GP review within 48 hours</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[#4A2E1D]">Recommended next steps</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center">
              <p className="text-[#4A2E1D]">Your scan includes GP review and report.</p>
              <p className="font-bold text-[#4A2E1D]">£99</p>
            </div>
            <p className="text-sm text-[#4A2E1D]/70 mt-1">One-time fee</p>
          </CardContent>
        </Card>
        ...
        {/* Continue button */}
        <Button
          asChild={!!selectedPayment}
          disabled={!selectedPayment}
          className="w-full bg-[#4A2E1D] hover:bg-[#3A2315] text-white rounded-full py-6 text-lg disabled:opacity-50 mb-4"
        >
          {selectedPayment ? (
            <Link href="/scan-your-mole">Continue to Scan Upload</Link>
          ) : (
            <span>Continue to Scan Upload</span>
          )}
        </Button>
